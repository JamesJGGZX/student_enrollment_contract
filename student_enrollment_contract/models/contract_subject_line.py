...
class ContractSubjectLine(models.Model):
    _name = "contract.subject.line"
    ...
    contract_id = fields.Many2one("student.enrollment.contract", string="Contract", ondelete="cascade")
