...
class StudentEnrollmentContract(models.Model):
    _name = "student.enrollment.contract"
    ...
    def create(self, vals):
        ...
        return super(StudentEnrollmentContract, self).create(vals)
    ...
    course_by_student_id = fields.Many2one("enrollment.subject.record", domain="[('student_id', '=', student_id)]", string="Enrollment Subject Record", tracking=True, required=True)
    ...
    contract_lines = fields.One2many("contract.subject.line", "contract_id", string="Contract Lines")
