...
class EnrollmentSubjectRecord(models.Model):
    _name = "enrollment.subject.record"
    ...
    courses_line_ids = fields.One2many("enrollment.subject.line", "course_id", string="Courses")
