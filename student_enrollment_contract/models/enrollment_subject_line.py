...
class EnrollmentSubjectLine(models.Model):
    _name = "enrollment.subject.line"
    _description = "Enrollment Subject Line"
    ...
    course_id = fields.Many2one("enrollment.subject.record", string="Course")
