...
export class StudentsContractDashboardGraphics extends Component {
    ...
    async getDashboardData() {
        ...
        let contractIds = [];
        const studentContractData = await this.orm.searchRead("student.enrollment.contract", domain, ["payment_state", "student_id"], {order: "create_date asc"});
        ...
        const subjectsByContracts = await this.orm.searchRead("contract.subject.line", [["contract_id", "in", contractIds]], ["subject_id", "teacher_id"], {order: "create_date asc"});
